...
<br/>
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2>Edition d'un user</h2>
            </div>
        </div>

        <div class="row">
            <div class="col-lg-6">
                <form action="{{ route('user.update', ['id'=>$utilisateur->id]) }}" method="POST">
                        {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="prenom" value="{{ $utilisateur->prenom }}" id="prenom" class="form-control"/>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" value="{{ $utilisateur->email }}" id="email" class="form-control"/>
                        @if ($errors->has('email'))
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tel" value="{{ $utilisateur->tel }}" id="tel" class="form-control"/>
                        @if ($errors->has('tel'))
